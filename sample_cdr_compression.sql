...
CREATE TABLE AAX2SW.COPY_C_CDRS TABLESPACE USERS AS
  SELECT * FROM AAX2SW.C_CDRS PARTITION (P20231029);
...
*/
CREATE TABLE AAX2SW.COPY_C_CDRS_BODY TABLESPACE USERS  AS
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231001)
  UNION
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231008)
  UNION
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231008)
  UNION
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231015)
  UNION
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231022)  
  UNION
  SELECT * FROM AAX2SW.C_CDRS_BODY PARTITION (P20231029);

/* D_TOLL_OBJECT_USAGE P20231001	AAX2_CDR_TAB_2023_10 */
CREATE TABLE AAX2SW.D_TOLL_OBJECT_USAGE TABLESPACE USERS AS
...
CREATE INDEX COPY_C_CDRS1$$ID ON COPY_C_CDRS (ID) TABLESPACE USERS;
CREATE INDEX COPY_C_CDRS1$DUPLICATE_CDR ON COPY_C_CDRS (CDR_ID) TABLESPACE USERS;
CREATE INDEX COPY_C_CDRS1$DUPLICATE_CHECK ON COPY_C_CDRS (CDR_ID, OBU_ID, FIRST_TIME_OF_TOLL_OBJ_DET_TS) TABLESPACE USERS;
CREATE INDEX COPY_C_CDRS1$DUPLICATE_OBU ON COPY_C_CDRS (OBU_ID) TABLESPACE USERS;

-- Index on C_CDRS_BODY table
CREATE INDEX COPY_C_CDRS_BODY1$$ID ON COPY_C_CDRS_BODY (ID) TABLESPACE USERS;
CREATE INDEX COPY_C_CDRS_BODY1$$TOLLUSAGE ON COPY_C_CDRS_BODY (TOLL_USAGE) TABLESPACE USERS;
CREATE INDEX COPY_C_CDRS_BODY1$CDR_RAW_ID ON COPY_C_CDRS_BODY (CDR_RAW_ID) TABLESPACE USERS;

-- Index on D_TOLL_OBJECT_USAGE table
CREATE INDEX COPY_D_TOLL_OBJECT_USAG1$REGION_OBU ON COPY_D_TOLL_OBJECT_USAGE (REGION, OBU) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE$TOU_ID ON COPY_D_TOLL_OBJECT_USAGE (TOU_ID) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE$US_AM ON COPY_D_TOLL_OBJECT_USAGE (USAGE, AMOUNT) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE1$$ID ON COPY_D_TOLL_OBJECT_USAGE (ID) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE1$$OBU ON COPY_D_TOLL_OBJECT_USAGE (EXIT_TIME, OBU, SYS_NC00016$) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE1$ENTITY ON COPY_D_TOLL_OBJECT_USAGE (ENTITY) TABLESPACE USERS;
CREATE INDEX COPY_D_TOLL_OBJECT_USAGE1$USAGE ON COPY_D_TOLL_OBJECT_USAGE (USAGE) TABLESPACE USERS;
